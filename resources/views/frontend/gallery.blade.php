    ...
    <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
                ...
                <li data-filter=".filter-app" class="filter-active">Anti-Corruption</li>
                <li data-filter=".filter-product">Access to Information</li>
                <li data-filter=".filter-branding">Digital Governance</li>
                <li data-filter=".filter-books">Natural Resources</li>
                <li data-filter=".filter-folio">Public Service Delivery</li>
